class Daily {
  ...
  factory Daily.fromJson(Map<String, dynamic> json) {
    return Daily(
      ...
      fawrySales: (json['fawry_sales'] ?? 0).toDouble(),
      ...
      fawryCosts: (json['fawry_costs'] ?? 0).toDouble(),
