...
class MyDropdownButton extends StatefulWidget {
  ...
  MyDropdownButton({required this.searchDates});
...
class _MyDropdownButtonState extends State<MyDropdownButton> {
  ...
  Map dates = {
    'فواتير الشهر': DateTime.now().subtract(Duration(days: 30)),
    'فواتير الاسبوع': DateTime.now().subtract(Duration(days: 7)),
  ...
  Widget build(BuildContext context) {
    return Center(
        child: DropdownButton<String>(
          ...
          iconSize: 18,
          elevation: 16,
          style: TextStyle(color: Colors.teal, fontFamily: 'Cairo', fontSize: 19),
          underline: Container(
            height: 2,
            color: Colors.black,
          ),
