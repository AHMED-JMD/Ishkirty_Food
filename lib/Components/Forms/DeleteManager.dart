...
class DeleteManager extends StatelessWidget {
  ...
  const DeleteManager({super.key, required this.data, required this.Delete});
        ...
        return Directionality(
            ...
            child: AlertDialog(
              ...
              actions: [
                Center(
                    child: Text(
                  'لن يتمكن ${data.username} من تسجيل الدخول مجددا',
  ...
  Widget build(BuildContext context) {
    return IconButton(
        ...
        icon: const Icon(Icons.delete_rounded, color: Color(0xff060d48)),
        tooltip: 'حذف');
  }
}
