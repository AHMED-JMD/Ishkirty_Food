...
class _EditSpiecesState extends State<EditSpieces> {
  ...
  Future _loadStores(String type) async {
    //call
    final res = await api.APIStore.getItems({'type': type});
    if (res.statusCode == 200) {
      final body = jsonDecode(res.body);
      List data = List.from(body);
  ...
  void _showForm({StoreAssociation? assoc, required String storeType}) {
    //call store api
                    ...
                    child: FormBuilder(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.only(bottom: 8.0, top: 50),
                            child: Center(
                              child: SizedBox(
                                height: 40,
                                width: 300,
                                child: TextButton(
                                  ...
                                  onPressed: () {
                                    if (_formKey.currentState!
                                      ...
                                      data['favBtn'] = _formKey
                                          .currentState!.value['favBtn'];
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //         ),
                        //         IconButton(
                        //           onPressed: () => _showForm(storeType: 'تصنيع'),
                        //           icon: const Icon(Icons.add),
                        //           tooltip: "اضافة ارتباط جديد",
                        //         )
                        //       ],
