                      ...
                      children: [
                        ...
                        FormBuilderDropdown(
                            ...
                            decoration: InputDecoration(
                                ...
                                icon: Icon(Icons.access_time, size: 20, color: Colors.teal,)
                            ),
                            items: ['صباحية', 'مسائية']
                        ...
                        FormBuilderTextField(
                          ...
                          decoration:  InputDecoration(
                            labelText: 'كلمة السر',
                            icon: Icon(Icons.password,size: 20,color: Colors.teal,),
                          ),
                          obscureText: true,
                          validator: FormBuilderValidators.required(errorText: 'الرجاء ادخال قيمة '),
                        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextButton(
          ...
          child: Text('اضافة كاشير جديد', style: TextStyle(color: Colors.black),)
      ),
    );
  }
}
